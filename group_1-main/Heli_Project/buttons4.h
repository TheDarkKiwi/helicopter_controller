...
// Constants
//*****************************************************************************
enum butNames {UP = 0, DOWN, LEFT, RIGHT, SWITCH1, SWITCH2, NUM_BUTS};
...
//SWITCH1 switch - SWITCH_BUT_PERIPH and SWITCH_BUT_PORT_BASE are the same for both switches, only the pins are different
#define SWITCH_BUT_PERIPH  SYSCTL_PERIPH_GPIOA
#define SWITCH_BUT_PORT_BASE  GPIO_PORTA_BASE
#define SWITCH1_BUT_PIN  GPIO_PIN_7
#define SWITCH1_BUT_NORMAL  false
//SWITCH2 switch
#define SWITCH2_BUT_PIN  GPIO_PIN_6
#define SWITCH2_BUT_NORMAL  false
